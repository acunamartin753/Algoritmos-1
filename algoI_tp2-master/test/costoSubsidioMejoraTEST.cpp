...
TEST(costoSubsidioMejoraTEST, todosNecesitan) {
    eph_h th = {
            {15726,2018,3,336630,646391,1,40,1,1,3,3,2},
            {188,2018,3,325187,635309,1,40,0,1,3,2,2},
            {123,2018,3,325187,635309,1,40,0,1,3,1,2},
            {777,2018,3,325187,635309,1,40,0,1,3,1,2},
            {789,2018,3,325187,635309,1,40,0,1,3,1,2},
    };
    ...
    eph_i ti = {
            ...
            {188,2018,5,0,3,1,29,1,2,1000,8},
            {188,2018,6,0,3,1,10,0,0,0,10},
            {123,2018,1,0,3,2,50,1,3,10000,0},
            {123,2018,2,0,3,1,47,1,3,10000,5},
            {123,2018,5,0,3,1,29,1,2,1000,8},
            {123,2018,6,0,3,1,10,0,0,0,10},
            {777,2018,1,0,3,2,60,0,0,6000,10},
            {777,2018,2,0,3,1,71,0,0,7000,10},
            {777,2018,3,0,3,1,39,1,2,2000,9},
            {777,2018,6,0,3,2,3,0,0,0,10},
            {789,2018,1,0,3,2,50,1,3,10000,0},
            {789,2018,2,0,3,1,47,1,3,10000,5},
            {789,2018,3,0,3,1,27,1,1,18000,8},
            {789,2018,4,0,3,1,26,1,3,16000,5},
    ...
    EXPECT_EQ(5*monto, res);
}

TEST(costoSubsidioMejoraTEST, noHayPresupuesto) {
    eph_h th = {
            {15726,2018,3,336630,646391,1,40,1,1,3,3,2},     // propia, no alcanzan
            {188,2018,3,325187,635309,1,40,0,1,3,2,2},       // propia, no alcanzan
            {11867,2018,3,320329,630940,1,43,1,1,3,2,2},     // propia, alcanzan
...
TEST(costoSubsidioMejoraTEST, soloHayUnHogar) {
    eph_h th = {
            {15726,2018,3,336630,646391,1,40,1,1,3,3,2},     // propia, no alcanzan
    };
