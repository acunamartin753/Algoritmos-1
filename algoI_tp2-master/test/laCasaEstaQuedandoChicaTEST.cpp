...
TEST(laCasaEstaQuedandoChica, hayCasasMas500) {
    eph_h th = {{20957, 2020,   3,  313965, 623297, 1,  41, 0,  1,  3,  1,  2},
...
TEST(laCasaEstaQuedandoChica, todasCasasMas500) {
...
TEST (laCasaEstaQuedandoChica, promediosNoEnteros) {
    eph_h th = {{20957, 2020,   3,  313965, 623297, 1,  41, 0,  1,  3,  1,  2},
                {21957, 2020,   3,  313964, 623296, 1,  41, 0,  1,  7,  5,  2},
                {22110, 2020,   3,  319611, 629088, 3,  42, 0,  1,  3,  1,  2}};
    ...
    eph_i ti = {{20957, 2020,   1,  1,  3,  1,  88, 0,  0,  90000,  10},
                ...
                {20957, 2020,   3,  1,  3,  2,  82, 0,  0,  25000,  10},
                {20957, 2020,   4,  1,  3,  2,  82, 0,  0,  25000,  10},
                {21957, 2020,   1,  1,  3,  1,  88, 0,  0,  90000,  10},
                {21957, 2020,   2,  1,  3,  1,  88, 0,  0,  90000,  10},
                {22110, 2020,   1,  0,  3,  1,  18, 0,  0,  20000,  10},
                {22110, 2020,   2,  0,  3,  1,  18, 0,  0,  20000,  10},
                {22110, 2020,   3,  0,  3,  1,  18, 0,  0,  20000,  10},
                {22110, 2020,   4,  0,  3,  1,  18, 0,  0,  20000,  10}};
